...
namespace App\Listeners\Partners\Webflow\Webhooks\CollectionItemChanged;
...
class HandleItemChanged implements ShouldQueue
{
    use InteractsWithQueue;

    public function handle(CollectionItemChanged $event): void
    {
