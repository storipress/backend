...
class GlobalOnlyApiDirective extends BaseDirective implements FieldMiddleware, TypeExtensionManipulator, TypeManipulator
{
    /**
...
"""
Restrict the target API can only be called from global scope.
"""
directive @globalOnlyApi repeatable on FIELD_DEFINITION | OBJECT
GRAPHQL;
    }
    ...
    public function handleField(FieldValue $fieldValue): void
    {
        $fieldValue->wrapResolver(
            fn (callable $previousResolver) => function (mixed $root, array $args, GraphQLContext $context, ResolveInfo $resolveInfo) use ($previousResolver) {
                ...
                if (str_contains($route, 'graphql') && $route !== 'graphql.central') {
