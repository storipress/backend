...
final class UnexpectedHttpException extends HttpException implements ClientAware, ProvidesExtensions
{
    /**
    ...
    {
        parent::__construct(500, 'Unexpected error. Please contact Storipress Technical Support.');
    }
